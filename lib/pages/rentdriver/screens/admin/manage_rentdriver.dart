...
import 'package:rentara_mobile/pages/main/widgets/navbarAdmin.dart';
import 'dart:convert';
import 'package:rentara_mobile/pages/rentdriver/screens/admin/edit_driver.dart';
import 'package:rentara_mobile/pages/rentdriver/models/rentdriver_models.dart';

class ManageDriverListApp extends StatefulWidget {
  const ManageDriverListApp({super.key});

  @override
  State<ManageDriverListApp> createState() => _ManageDriverListAppState();
}

class _ManageDriverListAppState extends State<ManageDriverListApp> {
                              ...
                              child: ListTile(
                                ...
                                onPressed: () async {
                                  final result = await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => EditDriverPage(driver: driver),
                                    ),
                                  );
